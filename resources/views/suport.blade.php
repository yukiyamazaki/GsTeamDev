...
<h1>利用規約</h1>
<p>この利用規約（以下，「本規約」といいます。）は，スクールハブ（以下，「当団体」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。</p>
...
<h2>第3条（登録メールアドレスおよびパスワードの管理）</h2>
<ol>
  <li>ユーザーは，自己の責任において，本サービスの登録メールアドレスおよびパスワードを適切に管理するものとします。</li>
  <li>ユーザーは，いかなる場合にも，登録メールアドレスおよびパスワードを第三者に譲渡または貸与し，もしくは第三者と共用することはできません。当団体は，登録メールアドレスとパスワードの組み合わせが登録情報と一致してログインされた場合には，その登録メールアドレスを登録しているユーザー自身による利用とみなします。</li>
  <li>登録メールアドレス及びパスワードが第三者によって使用されたことによって生じた損害は，当団体に故意又は重大な過失がある場合を除き，当団体は一切の責任を負わないものとします。</li>
</ol>

<h2>第4条（利用料金）</h2>
<p>ユーザーは，本サービスを無料で利用できます。</p>

<h2>第5条（デジタルコンテンツの取扱い）</h2>
<ol>
  <li>ユーザーは，自己の責任において，学校の授業で使用する自作の授業資料を本サービス上で公開（アップロード）することとします。他者の著作権を侵害するコンテンツは掲載できません。</li>
  <li>本サービスで資料を公開するユーザーは、他のユーザーがその資料をそのまま、または、一部修正して学校の授業で利用することを許可するもののします。</li>
  <li>ユーザーが作成し本サービス上で公開した資料の著作権は、その資料を作成したユーザーに帰属します。当団体は、本利用規約に基づくプラットフォームとしての機能を提供する立場であって、利用するユーザーに対してデジタルコンテンツの著作権の譲渡、貸与等を認めるものではありません。</li>
  <li>ユーザーが投稿した資料に関連する著作権違反によって生じた損害は，当団体は一切の責任を負わないものとします。</li>
  <li></li>
</ol>
...
<ol>
  ...
  <li>面識のない異性等との出会いを目的とした行為</li>
  <li>当団体のサービスに関連して，反社会的勢力に対して直接または間接に利益を供与する行為</li>
  <li>その他，当団体が不適切と判断する行為</li>
</ol>

<h2>第７条（本サービスの提供の停止等）</h2>
<ol>
  <li>当団体は，以下のいずれかの事由があると判断した場合，ユーザーに事前に通知することなく本サービスの全部または一部の提供を停止または中断することができるものとします。</li>
  <ol>
...
<h2>第８条（利用制限および登録抹消）</h2>
<ol>
  <li>当団体は，ユーザーが以下のいずれかに該当する場合には，事前の通知なく，ユーザーに対して，本サービスの全部もしくは一部の利用を制限し，またはユーザーとしての登録を抹消することができるものとします。</li>
  <ol>
